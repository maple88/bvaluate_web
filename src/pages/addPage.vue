    ...
    <div id="con">
      ...
      <div id="step">
        ...
        >
          ...
          <div class="upload_box" @drop="dropFile($event)">
          ...
          >
            <div class="upload_box_state_box">
              ...
              <div
                class="upload_box_state_box_state"
                v-show="opemTimer"
              >
                <div
                  class="upload_box_state_box_state_success"
      ...
      <div id="recommend">
        ...
        <div class="recommend_list">
          <ul>
            <li
              v-for="(item,index) in recommendProjects"
              :key="index"
            >
