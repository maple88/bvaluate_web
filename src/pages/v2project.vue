    ...
    <div class="v2maintainer pd0">
          ...
          <div class="projectTop">
            ...
            <div class="textRight">
              ...
              <div class="fol">
                ...
                <div
                  class="followbtn"
                  style="margin-left: 15px;background-color: #3555da;color: white"
      ...
      <div class="project-main">
        <div class="container v2container">
                ...
                <div class="item score-item">
                  ...
                  <div class="score-main">
                    <div class="scorel">
                      ...
                      <v-circle
                        :completeness="parseFloat(project.totalScore || 0)"
                    ...
                    <div class="scorer">
                      <p>
                        <span>
                          {{$t('Ranking of overall list')}}：
                          <i>{{completeness.rank}}</i>
                        </span>
                        <span>
                          {{completeness.rankAm | formatRank}}
                          <img
                            src="../assets/up.png"
                            v-if="completeness.rankAm > 0"
                          >
                      ...
                      <p v-if="completeness.stoRank !== 0">
                        <span>
                          {{$t('Ranking of STO list')}}：
                          <i>{{completeness.stoRank}}</i>
                        </span>
                        <span>
                          {{completeness.stoRankAm | formatRank}}
                          <img
                            src="../assets/up.png"
                            v-if="completeness.stoRankAm > 0"
                          >
              ...
              <div class="maincol">
                <div class="item industry-item">
                  ...
                  <div class="industry-tab">
                    <div
                      :class="indestyIndex === index ? 'on' : ''"
                      @click="changeIndesty(item.mark, index)"
                      v-for="(item, index) in completeness.trade"
                    >{{item.explain}}</div>
                  </div>
                  <div class="industry-main">
                    <div class="polygon_box">
                      <div class="polygon_img">
                        ...
                        <div
                          class="polygon_info"
                          :style="`bottom: ${completenessHandle(indestyMark)}%;`"
                        >
                          <div class="data_info">
                            <p>{{$t('Average score')}}</p>
                            <h4>
                  ...
                  <div class="media-main">
                    <div class="medial">
                      <div class="circle_box">
                        ...
                        <v-circle
                          :completeness="parseFloat(completeness.media) || 0"
          ...
          <div class="leftmain">
            ...
            <div class="bluesection">
              <div class="echartsbox1" ref="bluebox">
                ...
                <div
                  ref="radar"
                  class="githubLine"
                  :style="{width: '100%', height: '478px', padding: '15px 0'}"
                ></div>
              </div>
              <div class="details">
                <p class="total">
                  {{$t('Total score')}}：{{hotInfo.totalordercount}}
                  <span>/ 5</span>
                </p>
                <div class="item">
                  <div class="tit">
                    <img src="../assets/project/pb1.png">
                    <div class="word" v-if="$i18n.locale === 'cn'">
                      <span>资</span>
                      <span>金</span>
                      <span>监</span>
                      <span>管</span>
            ...
            <div class="project-projectMainTab" ref="bigBox">
                ...
                <div class="flexbox">
                  <div class="box-row">
                    ...
                    <div class="box-col" v-if="project.outerOfficial">
                      ...
                      <div class="itemr">
                        <a target="_blank" :href="project.outerOfficial">{{project.outerOfficial}}</a>
                      </div>
                    </div>
                    <!-- </div>
                    <div class="box-row">-->
                    ...
                    <div class="box-col">
                      ...
                      <div class="itemr">
                        <div
                          class="bps-btn"
                          @click="goArticle('/pdfShow', {project: project.project})"
                        >{{$t('Read White paper on-line')}}</div>
                      </div>
                    </div>
                    <!-- </div>
                    <div class="box-row">-->
              ...
              <div class="tabcontent project-tab-team" v-show="tabactive === 2">
                <div class="section2">
                  <div
                    class="swiper-container section-swiper orther_swiper"
                ...
                <div class="echartsbox4">
                  ...
                  <div class="control_button github_box">
                    ...
                    <div class="control_item">
                      ...
                      >{{$t('Quantity of collected projects')}}</button>
                    </div>
                  </div>
              ...
              <div class="tabcontent project-tab-news" v-show="tabactive >= 5">
                <div class="follow_list serach_follow_list">
                  <div class="label_box">
                    <a
                      name="search_label_box_xinwen"
                      id="search_label_box_xinwen"
                      data="新闻"
                      href="javascript:void(0);"
                      :class="search.type === 'NEWS'?'active':''"
                      @click="changeType('NEWS')"
                    >{{$t('News')}}</a>
                    <a
                      name="search_label_box_Twitter"
                      id="search_label_box_Twitter"
                      data="Twitter"
                      href="javascript:void(0);"
                      :class="search.type === 'TWITTER'?'active':''"
                      @click="changeType('TWITTER')"
                    >{{$t('Twitter')}}</a>
                    <a
                      name="search_label_box_weibo"
                      id="search_label_box_weibo"
                      data="微博"
                      href="javascript:void(0);"
                      :class="search.type === 'WEIBO'?'active':''"
                      @click="changeType('WEIBO')"
                    >{{$t('Microblog')}}</a>
                    <a
                      name="search_label_box_weixin"
                      id="search_label_box_weixin"
                      data="微信"
                      href="javascript:void(0);"
                          ...
                          <div class="media" v-for="(news, index) in newsList" :key="index">
                            ...
                            >
                              <div
                                class="newimg_box"
                                :data="news.title"
                                :name="'search_newimg_box_title_'+index"
                                :id="'search_newimg_box_title_'+index"
                                @click="goArticle('/article',{sid:news.sid}, $event)"
                              >
                                <img
                                  :src="news.titlePicture===''||news.titlePicture===null?newsimg:news.titlePicture"
                                >
                                <span
                                  class="time"
                                  v-if="!news.titlePicture"
                                >{{news.urlDate | formatTime}}</span>
                              </div>
                            </div>
                            <div
                              class="media-left media-middle"
                            ...
                            <div class="media-body">
                              ...
                              >
                                ...
                                >{{news.projectCategory | labelFormat}}</span>
                                <span
                                  class="tit"
                                  :data="news.title"
                                  :title="news.title"
                              ...
                              <p class="media-words" v-else v-html="news.content"></p>
                              <div class="media-bottom">
                                <ul>
                                  ...
                                  <li
                                    v-else
                                    :name="'search_media-bottom_siteName_'+index"
                                    :id="'search_media-bottom_siteName_'+index"
                                    :data="news.siteName"
                                  >{{news.siteName}}</li>
                                  <li>{{news.urlTime}}</li>
                                </ul>
          ...
          <div class="rightmain">
            <div
              class="swiper-container advert-swiper"
              @mouseenter="on_top_enter"
              @mouseleave="on_top_leave"
            >
              <div class="swiper-wrapper">
            ...
            <div class="recommendproject">
              ...
              <div
                ...
                v-for="(project, index) in recommendProjects"
                :key="index"
              >
                <router-link
...
export default {
    ...
    if (that.$route.query.multipage) {
      ...
      that
        ...
        .setOptions({
          ...
          steps: [{ intro: that.steps.content1 }]
        })
        .start()
        .onexit(function() {
          ...
          let clearTime = setTimeout(() => {
            ...
            let isCloseSignTip = sessionStorage.getItem(
              "apelink_user_close_sign_tip"
            );
            let isCloseRegisterTip = sessionStorage.getItem(
              "apelink_user_close_register_tip"
            );
            if (!token) {
              if (booleanShowSignin) {
                if (
                  that.$route.path !== "/login" &&
                  that.$route.path !== "/download"
                ) {
  ...
  mounted() {
    this.sw = new Swiper(".advert-swiper", {
      autoplay: {
  ...
  methods: {
    ...
    getMiddle(project) {
      this.$axios.get("/api/tradition/minute/" + project).then(res => {
    ...
    initMarketChart(data) {
      ...
      let str2 = `{
                    ...
                    "${this.$t(
                      "Number of users participating in circulation"
                    )}": false
                  }`;
      ...
      let marketLineOption = {
        ...
        legend: {
          ...
          data: [
            this.$t("Price"),
            this.$t("Number of circulation"),
            this.$t("Total amount of circulation"),
            this.$t("Number of users participating in circulation")
          ],
          selectedMode: false
        },
        grid: {
      ...
      this.$refs.marketLineButton1.addEventListener("click", e => {
        ...
        let className = $this.classList.toString();
        if (className.indexOf("check") !== -1) {
          marketLineOption.legend.selected[
            this.$t("Number of circulation")
          ] = false;
          $this.classList.remove("check");
        } else {
    ...
    initGithubLine(data) {
      ...
      let githubLineOption = {
        ...
        legend: {
          ...
          data: [
            this.$t("Average of nearly 30 days"),
            this.$t("Quantity of update"),
            this.$t("Page views"),
            this.$t("Quantity of collected projects")
          ], //'近30天平均值',
          selectedMode: false,
          x: "right"
        },
