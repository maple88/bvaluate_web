...
sensors.init({
  server_url: "http://bvaluate.datasink.sensorsdata.cn/sa?project=default&token=0195a6fbd8b2f627",//http://bvaluate.datasink.sensorsdata.cn/sa?project=production&token=0195a6fbd8b2f627
  //heatmap_url神策分析中点击分析及触达分析功能代码，代码生成工具会自动生成。如果神策代码中 `sensorsdata.min.js` 版本是 1.9.1 及以上版本，这个参数必须配置，低于此版本不需要配置。
  heatmap_url: "https://static.sensorsdata.cn/sdk/1.12.3/heatmap.min.js",   //heatmap
